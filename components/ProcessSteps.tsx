...
const ProcessSteps = () => {
  ...
  return (
    <section id="process" className="section-padding bg-white dark:bg-[#1f1f23]">
      <div className="container-max">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Step 1 */}
          <div className={`group relative bg-white dark:bg-white/10 dark:backdrop-blur-sm rounded-3xl p-8 border border-gray-100 dark:border-white/20 hover:border-primary-200 dark:hover:border-primary-500 hover:shadow-2xl transition-all duration-500 ${
            animations.step1 ? 'animate-slide-in-left' : 'pre-animate-hidden-left'
          }`}>
            {/* Velké číslo v pozadí */}
            <div className="absolute top-4 right-4 text-8xl font-bold text-primary-200 dark:text-primary-800 group-hover:text-primary-600 dark:group-hover:text-primary-500 transition-colors duration-500">
              01
            </div>

            {/* Ikona */}
            <div className="relative z-10 w-20 h-20 mb-8 bg-gradient-to-br from-primary-50 to-primary-100 dark:from-gray-200 dark:to-gray-300 rounded-2xl flex items-center justify-center text-primary-600 dark:text-gray-800 group-hover:from-primary-100 group-hover:to-primary-200 dark:group-hover:from-gray-300 dark:group-hover:to-gray-400 group-hover:scale-110 group-hover:rotate-6 transition-all duration-300">
            ...
            <div className="relative z-10">
              <h3 className="text-2xl sm:text-3xl font-heading font-semibold text-gray-800 dark:text-white mb-6 group-hover:text-primary-600 dark:group-hover:text-primary-400 transition-colors duration-300">
                Domluvíme
              </h3>
