...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="py-24 bg-white dark:bg-[#1f1f23]">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          {/* Contact Form */}
              ...
              >
                <div className="bg-gradient-to-br from-gray-50 to-white dark:from-white/10 dark:to-white/10 dark:backdrop-blur-sm rounded-2xl p-8 lg:p-12 border border-gray-200 dark:border-white/20 hover:shadow-lg transition-all duration-300">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-3 rounded-lg border transition-all duration-300 bg-white dark:bg-white/10 dark:text-gray-100 ${
                          focusedField === 'name' 
                            ? 'border-primary-500 ring-1 ring-primary-500 dark:border-primary-500' 
                            : 'border-gray-300 dark:border-white/20 hover:border-gray-400 dark:hover:border-white/30 focus:border-primary-500'
                        }`}
                    ...
                    <select
                      ...
                      className={`w-full px-4 py-3 rounded-lg border transition-all duration-300 bg-white dark:bg-white/10 dark:text-gray-100 ${
                        focusedField === 'businessType' 
                          ? 'border-primary-500 ring-1 ring-primary-500 dark:border-primary-500' 
                          : 'border-gray-300 dark:border-white/20 hover:border-gray-400 dark:hover:border-white/30 focus:border-primary-500'
                      } ${formData.businessType === '' ? 'text-gray-500 dark:text-gray-400' : 'text-gray-800 dark:text-gray-100'}`}
                    >
                      <option value="" className="text-gray-500 dark:text-gray-800 bg-white dark:bg-gray-200">Vyberte typ podnikání</option>
                      {businessTypes.map((type) => (
                        <option key={type} value={type} className="text-gray-800 dark:text-gray-800 bg-white dark:bg-gray-200">{type}</option>
                      ))}
                    </select>
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      onBlur={() => setFocusedField('')}
                      rows={4}
                      className={`w-full px-4 py-3 rounded-lg border transition-all duration-300 resize-none bg-white dark:bg-white/10 dark:text-gray-100 ${
          ...
          >
            <div className="space-y-8">
              {/* Contact Details */}
              <div className="bg-gradient-to-br from-gray-50 to-white dark:from-white/10 dark:to-white/10 dark:backdrop-blur-sm rounded-2xl p-8 lg:p-12 border border-gray-200 dark:border-white/20">
                <h3 className="text-2xl sm:text-3xl font-heading font-semibold text-gray-800 dark:text-white mb-8">
                  Kontaktní informace
                </h3>
                ...
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 bg-gradient-to-br from-primary-100 to-primary-200 dark:from-gray-200 dark:to-gray-300 rounded-lg flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-primary-600 dark:text-gray-800" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                      </svg>
                    </div>
                    <div>
                      <h4 className="font-semibold text-gray-900 dark:text-white">Email</h4>
                      <p className="text-gray-600 dark:text-gray-300">info@rezit.cz</p>
                    </div>
                  </div>
                  
                  <a href="https://instagram.com/rezit.cz" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 hover:opacity-80 transition-opacity">
                    <div className="w-10 h-10 bg-gradient-to-br from-primary-100 to-primary-200 dark:from-gray-200 dark:to-gray-300 rounded-lg flex items-center justify-center flex-shrink-0">
                      <svg className="w-5 h-5 text-primary-600 dark:text-gray-800" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 dark:text-gray-300">@rezit.cz</p>
                    </div>
                  </a>
                </div>
              </div>
