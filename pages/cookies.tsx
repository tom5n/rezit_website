        ...
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="w-full">
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Co jsou cookies?</h2>
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Jaké cookies používáme?</h2>
              
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-3">Nezbytné cookies</h3>
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-3">Analytické cookies</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
              ...
              <h3 className="text-xl font-semibold text-gray-800 dark:text-white mb-3">Marketingové cookies</h3>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Jak můžete cookies spravovat?</h2>
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Třetí strany</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
