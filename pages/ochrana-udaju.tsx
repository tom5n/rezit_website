...
export default function OchranaUdaju() {
  return (
    <>
      ...
      />
      <Layout>
      <section className="min-h-screen bg-white dark:bg-[#1f1f23] py-24">
        <div className="container-max px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="w-full">
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Jaké údaje zpracováváme</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
                V rámci poskytování našich služeb zpracováváme následující kategorie osobních údajů:
              </p>
              <ul className="list-disc list-inside text-gray-600 dark:text-gray-300 space-y-2 ml-4 mb-8">
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Účel zpracování</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Právní základ zpracování</h2>
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Doba uchovávání</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Vaše práva</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Předávání údajů třetím stranám</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Zabezpečení údajů</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-8">
              ...
              <h2 className="text-3xl font-heading font-bold text-gray-800 dark:text-white mb-6">Kontakt</h2>
              <p className="text-gray-600 dark:text-gray-300 leading-relaxed mb-4">
