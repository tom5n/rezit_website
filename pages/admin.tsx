        ...
        <div className="h-full bg-white flex flex-col justify-between">
          ...
          <div className="flex-1 flex items-center justify-center">
            <nav className="flex flex-col space-y-8 text-center">
              ...
              <a 
                href="https://konfigurator.rezit.cz/admin"
                target="_blank"
          ...
          <div className="px-6 py-2">
            ...
            <div className="space-y-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-full text-left px-3 py-2 rounded-lg font-sans text-base transition-all duration-200 relative text-gray-600 hover:bg-gray-100 hover:text-gray-800 hover:border-l-4 hover:border-gray-300 flex items-center gap-2"
              >
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10.325 4.317c.426-1.756 2.924-1.756 3.35 0a1.724 1.724 0 002.573 1.066c1.543-.94 3.31.826 2.37 2.37a1.724 1.724 0 001.065 2.572c1.756.426 1.756 2.924 0 3.35a1.724 1.724 0 00-1.066 2.573c.94 1.543-.826 3.31-2.37 2.37a1.724 1.724 0 00-2.572 1.065c-.426 1.756-2.924 1.756-3.35 0a1.724 1.724 0 00-2.573-1.066c-1.543.94-3.31-.826-2.37-2.37a1.724 1.724 0 00-1.065-2.572c-1.756-.426-1.756-2.924 0-3.35a1.724 1.724 0 001.066-2.573c-.94-1.543.826-3.31 2.37-2.37.996.608 2.296.07 2.572-1.065z" />
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                        ...
                        <div key={project.id || 'unknown'}>
                          ...
                          >
                            <div className="flex justify-between items-start mb-3">
                              ...
                              {/* Status tag v pravém horním rohu - Mobile */}
                              <div className="flex items-center gap-2 flex-shrink-0">
                                {project.status === 'completed' ? (
                                  <span className="px-2 py-0.5 text-xs font-semibold bg-green-100 text-green-700 rounded-full">
                                    ✓ Dokončeno{project.deadline ? `: ${formatDate(project.deadline)}` : ''}
                                  </span>
                                ) : (
                          ...
                          >
                            ...
                            <div className="flex justify-between items-start mb-6">
                              ...
                              {/* Status tag a deadline v pravém horním rohu */}
